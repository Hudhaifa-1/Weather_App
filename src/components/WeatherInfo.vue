...
const emit = defineEmits(['hide-detial', 'remove-place'])

const handleDetial = () => {
  emit('hide-detial', false)
}
</script>

<template>
  <div
    class="absolute mx-5 my-5 bg-white/20 backdrop-blur text-slate-900 inset-x-0 bottom-0 rounded-lg p-8"
  >
    <!-- Close button -->
    <div class="flex justify-end mb-10">
      <button @click="handleDetial" class="p-1">
